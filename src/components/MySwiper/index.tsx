  ...
  return (
    <>
      ...
      >
        ...
        <SwiperSlide>
          <SwiperCard Icon={HeartIcon} title="Vitalidade" description="Cuide do seu corpo por meio de uma dupla abordagem para a sua saúde, a qual inclui um plano nutricional exclusivo e um programa de exercícios adaptado às suas necessidades." />
        </SwiperSlide>
        <SwiperSlide>
        ...
        <SwiperSlide>
          <SwiperCard Icon={BoltIcon} title="Maior Produtividade" description="Potencialize sua produtividade diária com planos de nutrição e treinamento individualizados que te proporcionam uma rotina mais ativa." />
        </SwiperSlide>
        <SwiperSlide>
          <SwiperCard Icon={TrophyIcon} title="Metas Conquistadas" description="Supere suas metas com o apoio de especialistas que o ajudarão a traçar e alcançar as suas metas da melhor forma possível." />
        </SwiperSlide>
      </Swiper>
    </>
  )
